  ...
  try {
    ...
    const mailOption = {
      ...
      html:
        "<p> Hello " +
        name +
        ',please click here <a href="https://hufiko.shop/verify?name=' +
        name +
...
const postOtp = async (req, res) => {
  try {
    ...
    console.log("mobile");
    const result = await client.verify.v2.services(services).verificationChecks.create({
  ...
  try {
    ...
    const mailOption = {
      ...
      html:
        "<p> Hello " +
        name +
        ',please click here <a href="https://hufiko.shop/resetpass?token=' +
        token +
...
// Return COD Order
const returnConformed = async (req, res) => {
  try {
    const id = req.query.id;
...
const applyCoupon = async (req, res) => {
  try {
    ...
    const alreadyCoupon = await Coupon.findOne({
      code: code,
